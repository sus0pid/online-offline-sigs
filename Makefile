...
PROJECT := ONLINE-OFFLINE-NUCLEO-F767ZI
...
OBJECTS += falcon-lazy/shake.o falcon-lazy/sign.o  falcon-lazy/vrfy.o
...
C_DEFS += -O2 -fomit-frame-pointer -fstack-usage -fdump-tree-original -fdump-rtl-dfinish
